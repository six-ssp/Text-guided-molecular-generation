...
class GaussianDiffusion:
    ...
    def training_losses(self, model, *args, **kwargs):
        ...
        elif self.training_mode == 'latent':
            return self.training_losses_latent(model, *args, **kwargs)
    ...
    def training_losses_latent(self, model, micro, t, model_kwargs=None, noise=None):
        """
        Train directly in sdvae latent space with text conditioning.

        Expected micro tuple:
        - latent: [batch, latent_dim]
        - desc_state: [batch, seq_len, 768]
        - desc_mask: [batch, seq_len]
        """
        x_start = micro[0]
        desc_state = micro[1]
        desc_mask = micro[2]
